...
//<![CDATA[
                ...
                <table cellpadding="6" width="850px" height="200px">
                  ...
                  <tr>
                    ...
                    <td><b>Escolher</b></td>
                                                          ...
                                                          $sql = "SELECT DISTINCT nick, data_hora, custo_passageiro, nome_origem, nome_destino, nick_condutor, matricula FROM Boleia WHERE matricula IS NULL";
				...
				$_SESSION['nick_organizador'] = $row_array['nick'];
$_SESSION['data_hora'] = $row_array['data_hora'];
                                                          echo("<tr>");
