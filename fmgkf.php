	...
	<div style="width: 100%;" align="center">
		<div class="box">
		  ...
		  <div style="float: left; margin-left: 5px;width=674">
		    ...
		    <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="628" height="106" >
              <param name="movie" value="a.swf" />
              <param name="quality" value="high" />
              <embed src="a.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="628" height="106"></embed>
	        </object>
		  </div><!-- end of flashdiv-->


		</div><!-- end of box-->
		<div class="bottommenu" style="float: left;  margin-top: 0px;">
			<ul style="float: left;list-style:none; ">
			
			 	<li><a href="https://filedropper.com/signup" ><span class="active">Sign Up Free</span></a> </li> <li> <a href="http://filedropperpro.com/filemanager/index.php" >Login</a> </li> 				
				
				<li><a href="contact.php">Contact</a></li>
				
				<li><a href="aboutus.php">About Us</a></li>
                
                <li><a href="abuse_form.php">Report Abuse - Request File Removal</a></li>
