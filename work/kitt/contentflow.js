...
ContentFlow.prototype = {
    ...
    _defaultConf: { 
        ...
        fixItemSize: false,
        relativeItemPosition: "bottom bellow", // align top/above, bottom/below, left, right, center of position coordinate
        ...
        keys: {
            13: function () { this.conf.onclickActiveItem(this._activeItem); sessvars.n_clicks++;},
